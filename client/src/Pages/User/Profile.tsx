        ...
        <div className="card-body">
          <div className="row">
            ...
            <div className="col-sm-9">
              ...
              <p className="m-0">{`Account Created: ${new Date(profileData.stats.dateCreated).toLocaleString(undefined, { year: 'numeric', month: 'long', day: 'numeric' })}`}</p>
              <p className="m-0">{`Last Active: ${new Date(profileData.stats.lastActive).toLocaleString(undefined, { year: 'numeric', month: 'long', day: 'numeric' })}`}</p>
            </div>
          </div>
