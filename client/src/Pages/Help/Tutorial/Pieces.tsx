...
import * as Images from 'src/Assets/tutorial-images';
...
export const Pieces: Content[] = [
  {
    ...
    description: (
      <React.Fragment>
        <Typography variant="h5" gutterBottom>Pawn</Typography>
  ...
  },
  {
    ...
    description: (
      <React.Fragment>
        <Typography variant="h5" gutterBottom>Knight</Typography>
        <Typography paragraph>
  ...
  },
  {
    ...
    description: (
      <React.Fragment>
        <Typography variant="h5" gutterBottom>Bishop</Typography>
        <Typography paragraph>
  ...
  },
  {
    ...
    description: (
      <React.Fragment>
        <Typography variant="h5" gutterBottom>Queen</Typography>
        <Typography paragraph>
  ...
  },
  {
    ...
    description: (
      <React.Fragment>
        <Typography variant="h5" gutterBottom>King</Typography>
        <Typography paragraph>
