...
export const Specials: Content[] = [
  {
    ...
    description: (
      <React.Fragment>
        <Typography variant="h5" gutterBottom>Castling</Typography>
  ...
  },
  {
    ...
    description: (
      <React.Fragment>
        <Typography variant="h5" gutterBottom>Promotion</Typography>
        <Typography paragraph>
  ...
  },
  {
    ...
    description: (
      <React.Fragment>
        <Typography variant="h5" gutterBottom>En Passant</Typography>
        <Typography paragraph>
