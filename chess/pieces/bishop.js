const { Piece, diagonalMove }  = require('./base');

function Bishop(name, color, px, py, notation)  {
...
Bishop.prototype.listOfMoves = function(pieces) {
  let possibleMoves = {
...
Bishop.prototype.legalMove = function(pieces, spotClicked) {
  if (!Piece.prototype.legalMove.call(this, pieces, spotClicked)) return false;
  return this.diagonalMove(pieces, spotClicked);
}
